...
export default function Button({
  ...
  const styles = {
    ...
    secondary:
      "text-xs md:text-sm px-4 py-2.5 focus:text-stone-800 md:px-6 md:py-3.5 border-2 border-stone-300 uppercase font-semibold text-stone-400 inline-block tracking-wide rounded-full hover:bg-stone-500 hover:text-stone-800 transition-colors duration-300 focus:outline-none focus:ring focus:ring-stone-300 focus:bg-stone-300 focus:ring-offset-2 disabled:cursor-not-allowed ",
  };
  if (to)
    return (
